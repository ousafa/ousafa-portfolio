      ...
      <RevealOnScroll>
        <div className="text-center z-10 px-4">
          ...
          <p className="tex-gray-400 text-lg mb-8 max-w-lg mx-auto">
            I am a recent graduate full-stack developer, eager to achieve my
            goals through gaining extensive experience.
          </p>

          <div className="flex justify-center space-x-4">
            <a
              href="https://drive.google.com/file/d/1HvUNV8CsSC7VwH17zzUEcNDouH6slXdm/view?usp=sharing"
              target="_blank"
