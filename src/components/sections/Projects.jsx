        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-orange-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
            ...
            <p className="text-gray-400 mb-4">
              ...
              members, space reservations, events, subscriptions, invoices, and
              various other management aspects. On the other hand, users will be
              able to book workspaces, register for events offered by the space,
              and manage their personal profiles.
            </p>
          ...
          >
            ...
            <p className="text-gray-400 mb-4">
              ...
              interpret medical images. Built with a collaborator, this platform
              leverages AI to help users understand their health conditions. It
              allows users to input symptoms for analysis or upload medical
              images for interpretation, providing preliminary insights before
